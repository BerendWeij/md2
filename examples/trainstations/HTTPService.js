/**
 * de constructor van HTTPService. Hierbinnen doen we niets
...
/*
HTTPService zou niet perse een prototype object hoeven te zijn
Je zou het ook binnen 1 object kunnen laten vallen:




var HTTPService = {get: function(url, callback) {
    // om data op te kunnen halen hebben we een XMLHttpRequest nodig
    var xmlhttp = new XMLHttpRequest();
    // je geeft eerst de method GET/POST en de url door
    xmlhttp.open("GET", url);
